...
if other.enemy = false && (other.image_alpha = 1 or disabled) and !invincible {
	...
	if flash_alpha = 0 or disabled {
		...
		if sprite_centered {
			...
			part_particles_create(global.particle_sys, other.x + lengthdir_x(image_xscale*sprite_get_width(sprite_index)/2, image_angle), other.y + lengthdir_y(image_yscale*sprite_get_height(sprite_index)/2, image_angle), enemy_type_particle, 30);
		}
