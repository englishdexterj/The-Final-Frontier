...
global.enemy[5] = "Rusher";
global.enemy[6] = "Ranger";
global.enemy[7] = "Gunship";
global.enemy[8] = "Destroyer";
global.enemy[9] = "Shotgunner";
global.enemy[10] = "Swarmer";
global.enemy[11] = "Heavy Cruiser";
global.enemy[12] = "Battlecruiser";
...
if file_exists("stats.txt") {
	...
	while !file_text_eof(file) {
		...
		global.stats[j, 0] = file_text_read_string(file); //name
		file_text_readln(file);
	...
	if j < array_length(global.enemy) {
		var file = file_text_open_append("stats.txt");
		for (var i = j; i < array_length(global.enemy); i++) {
