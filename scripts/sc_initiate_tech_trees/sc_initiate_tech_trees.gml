function sc_initiate_tech_trees() {
	#region fighter tech tree
	if global.selected_character = 0 {
	var k = 0;
	//row 1
	upgrade[k, up.name] = "";					upgrade[k, up.sprite] = 0; 					upgrade[k, up.req1] = -4; 					upgrade[k, up.req2] = -4;  					upgrade[k, up.active_max] = -4; k++;
	upgrade[k, up.name] = "";					upgrade[k, up.sprite] = 0; 					upgrade[k, up.req1] = -4; 					upgrade[k, up.req2] = -4;  					upgrade[k, up.active_max] = -4; k++;
	upgrade[k, up.name] = "";					upgrade[k, up.sprite] = 0; 					upgrade[k, up.req1] = -4; 					upgrade[k, up.req2] = -4;  					upgrade[k, up.active_max] = -4; k++;
	upgrade[k, up.name] = "";					upgrade[k, up.sprite] = 0; 					upgrade[k, up.req1] = -4; 					upgrade[k, up.req2] = -4;  					upgrade[k, up.active_max] = -4; k++;
	upgrade[k, up.name] = "";					upgrade[k, up.sprite] = 0; 					upgrade[k, up.req1] = -4; 					upgrade[k, up.req2] = -4;  					upgrade[k, up.active_max] = -4; k++;
	...
	#region healer tech tree
	if global.selected_character = 3 {
	var k = 0;
	//row 1
	upgrade[k, up.name] = "";					upgrade[k, up.sprite] = 0; 					upgrade[k, up.req1] = -4; 					upgrade[k, up.req2] = -4;  					upgrade[k, up.active_max] = -4; k++;
	upgrade[k, up.name] = "";					upgrade[k, up.sprite] = 0; 					upgrade[k, up.req1] = -4; 					upgrade[k, up.req2] = -4;  					upgrade[k, up.active_max] = -4; k++;
